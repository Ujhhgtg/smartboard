...
// 应用程序状态
pub struct AppState {
    pub strokes: Vec<DrawingStroke>,                // 笔迹
    pub images: Vec<InsertedImage>,                 // 插入的图片
    pub texts: Vec<InsertedText>,                   // 插入的文本
    pub shapes: Vec<InsertedShape>,                 // 插入的形状
    ...
    pub dynamic_brush_mode: DynamicBrushMode,       // 动态画笔大小微调
    pub stroke_smoothing: bool,                     // 笔画平滑选项
    pub current_tool: Tool,                         // 当前工具
    pub eraser_size: f32,                           // 橡皮擦大小
    pub background_color: Color32,                  // 背景颜色
    pub selected_object: Option<SelectedObject>,    // 选中的对象
