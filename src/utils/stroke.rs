...
use crate::state::{
    ActiveStroke, AppState, CanvasObject, CanvasStroke, DynamicBrushWidthMode, StrokeWidth,
};

pub fn brush_stroke_start(state: &mut AppState, touch_id: u64, pos: Pos2) {
...
pub fn brush_stroke_end(state: &mut AppState, touch_id: u64) {
